...
// SetsCache describes a cache interface whose values are sets
type SetsCache[Key, Value any] interface {
...
type ProviderStore SetsCache[mh.Multihash, model.ProviderResult]
